...
1.  **ZIP Dosyası:** "Gaen Studio.zip" dosyasının içeriğini zip ile ana dizine çıkarın.
3.  **Kısayol Oluşturma:** "Gaen Studio.exe" dosyasının kısayolunu oluşturup kullanabilirsiniz.
4.  **Hızlı Arama:** Windows arama çubuğuna direkt olarak **"Gaen Studio"** yazarak uygulamayı aratıp başlatabilirsiniz.
...
1.  **Dosya Yolu:** `EYC -> dist -> eyc` klasör yolunu takip ederek `eyc.exe` dosyasını bulun.
